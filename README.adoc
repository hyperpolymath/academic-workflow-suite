...
:experimental:
:url-github: https://github.com/hyperpolymath/Academic-Workflow-Suite
:url-gitlab: https://gitlab.com/hyperpolymath/Academic-Workflow-Suite
:url-bitbucket: https://bitbucket.org/hyperpolymath/Academic-Workflow-Suite
:url-codeberg: https://codeberg.org/hyperpolymath/Academic-Workflow-Suite

Academic research workflow automation and citation management
...
Academic-Workflow-Suite is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
